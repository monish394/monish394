...
- Full-stack expense management web application  
- Built with **React, Node.js, Express, MongoDB**
- Implemented **JWT authentication**
- Integrated **AI receipt scanning using Google Gemini**

### 🛠 Asset Maintenance System

- Asset tracking and maintenance workflow system  
- Role-based dashboards for **Admin, Technician, and User**
